  ...
  if (isOffline) {
    ...
    try {
      const transformedProduct: OfflineProduct = {
        ...
        minStock: tempProduct.minStock ?? 0,
  ...
  if (isOffline || !existingProduct) {
    ...
    if (existingProduct) {
      const updatedProduct: OfflineProduct = {
        ...
        description: (data.description !== undefined ? data.description : existingProduct.description) ?? undefined,
        sku: data.sku ?? existingProduct.sku ?? '',
        barcode: (data.barcode !== undefined ? data.barcode : existingProduct.barcode) ?? undefined,
        ...
        minStock: data.minStock !== undefined ? data.minStock : existingProduct.minStock ?? 0,
        categoryId: (data.categoryId !== undefined ? data.categoryId : existingProduct.categoryId) ?? undefined,
        supplierId: (data.supplierId !== undefined ? data.supplierId : existingProduct.supplierId) ?? undefined,
      ...
      return {
        ...
        minStock: updatedProduct.minStock ?? 0,
