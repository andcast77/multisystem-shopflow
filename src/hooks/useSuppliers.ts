...
async function fetchSupplier(id: string): Promise<Supplier> {
  ...
  return {
    ...
    contactPerson: offlineSupplier.contactPerson ?? null,
  ...
  if (isOffline) {
    ...
    try {
      const transformedSupplier: OfflineSupplier = {
        ...
        contactPerson: tempSupplier.contactPerson ?? undefined,
  ...
  if (isOffline || !existingSupplier) {
    ...
    if (existingSupplier) {
      const updatedSupplier: OfflineSupplier = {
        ...
        email: (data.email !== undefined ? data.email : existingSupplier.email) ?? undefined,
        phone: (data.phone !== undefined ? data.phone : existingSupplier.phone) ?? undefined,
        address: (data.address !== undefined ? data.address : existingSupplier.address) ?? undefined,
        city: (data.city !== undefined ? data.city : existingSupplier.city) ?? undefined,
        state: (data.state !== undefined ? data.state : existingSupplier.state) ?? undefined,
        postalCode: (data.postalCode !== undefined ? data.postalCode : existingSupplier.postalCode) ?? undefined,
        country: (data.country !== undefined ? data.country : existingSupplier.country) ?? undefined,
        contactPerson: (data.contactPerson !== undefined ? data.contactPerson : existingSupplier.contactPerson) ?? undefined,
